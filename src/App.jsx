  ...
  <div style={{ position: "relative", width: size, height: size, overflow: "visible", isolation: "isolate" }}>
    ...
    >
      <div style={{ position: "relative", width: size, height: size, overflow: "visible", isolation: "isolate" }}>
        ...
        {!isLibrary && (
          <svg style={{ position: "absolute", top: -8, left: 0, width: "100%", height: "100%", pointerEvents: "none", zIndex: 2 }} viewBox="0 0 110 110">
...
{swiped && <div style={{ position: "absolute", bottom: 14, right: -8, color: currentPartieColor.light, fontSize: 8, opacity: 0.6 }}>→</div>}
</div>
);
}
...
return (
  <div style={{ background: "#0D0D1A", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", maxWidth: 430, margin: "0 auto" }}>
    ...
    <div style={{ background: "linear-gradient(180deg, #1A0A2E 0%, #0D0D1A 100%)", padding: "44px 20px 20px", position: "sticky", top: -8, zIndex: 10 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
