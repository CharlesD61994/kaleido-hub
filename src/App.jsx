...
// ============================================
// WRAPPERS VERCEL - localStorage & navigator
// ============================================
...
console.error(`[Storage] Erreur ${key}:`, error);
return defaultValue;
}
};
...
const safeGetTouchCoords = (event) => {
if (!isBrowser || !event) return null;
try {
...
const currentRaw = getStorage(DB_KEY);
if (currentRaw) setStorage(DB_BACKUP_KEY, currentRaw);
